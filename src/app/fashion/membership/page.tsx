...
export default function MembershipPage() {
  ...
  return (
    <section className="flex flex-col items-center justify-center p-4 sm:p-12 md:pt-16 xl:pt-24 ">
      ...
      <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-indigo-200 rounded-bl-full opacity-50 -z-10"></div>
      <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-indigo-200 rounded-tr-full opacity-50 -z-10"></div>
    </section>
  )
}
